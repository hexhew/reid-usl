...
from reid.core import Evaluator
...
def parse_args():
    ...
    parser.add_argument(
        ...
        'workers, avaiable when gpu-collect is not specified')
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
    ...
    parser.add_argument(
        ...
        'format will be kwargs for evaluation')
    parser.add_argument(
        '--launcher',
...
def main():
    ...
    evaluator['progbar'] = True  # always show ProgressBar
